...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group <?php echo (!empty($confirm_password_err)) ? 'has-error' : ''; ?>"><br><br>
                <label>Confirmar Contraseña</label><br><br>
                <input type="password" name="confirm_password" class="form-control" value="<?php echo $confirm_password; ?>"><br><br>
                <span class="help-block"><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Ingresar"><br><br>
                <input type="reset" class="btn btn-default" value="Borrar"><br>
            </div>
            <p>¿Ya tienes una cuenta? <a href="login.php"><BR>Ingresa aquí</a>.</p>
            </center>
        </form>
    </div>    
</body>
